...
// line 2 "../../../../../RestoAppTableStateMachine.ump"
...
public class Table implements Serializable
{
  ...
  public boolean endOrder(Order o)
  {
    ...
    switch (aStatus)
    {
      ...
      case Ordered:
        if (allSeatsBilled())
        {
        // line 145 "../../../../../RestoAppTableStateMachine.ump"
  ...
  public boolean cancelOrderItem(OrderItem i)
  {
    ...
    switch (aStatus)
    {
      case Ordered:
        ...
        if (!(iIsLastItem(i)))
        {
        // line 58 "../../../../../RestoAppTableStateMachine.ump"
          // delete order item
           List<Seat> seatList = new ArrayList<Seat>();
    		seatList = i.getSeats();
    		for(Seat s: seatList)
   ...
   */
  // line 152 "../../../../../RestoAppTableStateMachine.ump"
   ...
   */
  // line 162 "../../../../../RestoAppTableStateMachine.ump"
